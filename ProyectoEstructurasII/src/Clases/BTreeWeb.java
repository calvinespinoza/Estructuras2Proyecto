...
public class BTreeWeb<Key extends Comparable<Key>, Value>  {
        ...
        // internal node
            ...
            for (int j = 0; j < x.m; j++) {
                if (j+1 == x.m || less(key, children[j+1].key))
                    return search(children[j].next, key, ht-1); //No entiendo aqui que pedo hace con childre[j].next
            }
        }
        return null;
    }
    ...
    public void put(Key key, Value val) {
        ...
        t.children[1] = new Entry(u.children[0].key, null, u); //Por qe manda u?
        root = t;
        height++;
    }
    ...
    public static void main(String[] args) {
        BTreeWeb<String, String> st = new BTreeWeb<String, String>();
